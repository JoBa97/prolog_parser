...
std::vector<std::string> ABlock::toInstructions() const {
  ...
  std::ostringstream u1_instr;
  u1_instr << u_1_node_id
            << " U ("
            << u_2_node_id
            << ", 2) - "
            << u_lit_info;
  instructions.push_back(u1_instr.str());

  std::ostringstream u2_instr;
  u2_instr << u_2_node_id
            << " U ("
            << a_node_id
            << ", 1) - ";
  instructions.push_back(u2_instr.str());
  ...
  std::ostringstream u3_instr;
  u3_instr << u_3_node_id
            << " U "
            << u_node_out_1.repr()
            << " - ";
  instructions.push_back(u3_instr.str());
